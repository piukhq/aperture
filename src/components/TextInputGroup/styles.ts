...
export const INPUT_STYLE_MAPS: Record<InputStyle, { container: string, label: string, input: string, icon: string}> = {
  [InputStyle.UNDERLINE_ICON_LEFT]: {
    container: 'h-[48px]',
    label: 'hidden',
    input: 'w-full h-[48px] pl-9 border-b-[1px] bg-transparent font-body text-base tracking[.006rem]',
    icon: 'absolute top-[12px] left-[1px] w-[25px] h-[15px]',
  },
  [InputStyle.UNDERLINE_ICON_LEFT_SMALL]: {
    container: 'h-[42px]',
    label: 'hidden',
    input: 'w-full h-[39px] pl-9 border-b-[1px] bg-transparent font-body text-sm tracking[.006rem]',
  ...
  [InputStyle.UNDERLINE_ICON_RIGHT]: {
    ...
    input: 'w-full h-[39px] pl-1 pr-10 border-b-[1px] bg-transparent font-body text-base tracking[.006rem]',
    icon: 'absolute top-[8px] right-[1px]',
  },
  [InputStyle.UNDERLINE_ICON_RIGHT_SMALL]: {
    container: 'h-[55px]',
    label: 'absolute top-[-13px] px-1 text-2xs text-grey-500 font-body bg-white dark:bg-grey-850 z-10 tracking-[0rem]',
    input: 'w-full h-[37px] pr-10 pl-1 border-b-[1px] bg-transparent font-body text-sm tracking-[.006rem]',
    icon: 'absolute top-[5px] right-[10px]',
  },
  [InputStyle.UNDERLINE_SMALL_LABEL_HIDDEN]: {
    container: 'h-[55px]',
    label: 'hidden',
    input: 'w-full h-[39px] p-1 border-b-[1px] bg-transparent font-body text-sm tracking-[.006rem] placeholder-grey-600',
  ...
  [InputStyle.FULL]: {
    ...
    input: 'w-full h-full p-4 bg-transparent border rounded-[10px] font-body text-sm tracking[.006rem] text-grey-800',
    icon: null,
  },
  ...
  [InputStyle.FULL_SMALL]: {
    container: 'h-[42px]',
    label: 'absolute top-[-8px] left-[13px] h-[10px] bg-white dark:bg-grey-850 bg-bottom px-1text-4xs font-body z-10',
    input: 'w-full h-full p-4 bg-transparent border rounded-[10px] font-body text-sm tracking[.006rem] text-grey-800',
    icon: null,
  },
  ...
  [InputStyle.TRANSPARENT_ICON_LEFT_SMALL]: {
    container: 'h-[42px]',
    label: 'hidden',
    input: 'w-full h-[39px] pl-12 bg-transparent rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute top-[10px] left-[20px]',
  },
  [InputStyle.TRANSPARENT_ICON_RIGHT_SMALL]: {
    container: 'h-[50px] flex items-center',
    label: 'hidden',
    input: 'w-full h-[50px] pl-7 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute right-[18px]',
  },
  [InputStyle.WHITE_ICON_LEFT_SMALL]: {
    container: 'h-[42px]',
    label: 'hidden',
    input: 'w-full h-[39px] pl-12 bg-grey-100 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute top-[10px] left-[20px]',
  },
  [InputStyle.WHITE_ICON_RIGHT_SMALL]: {
    container: 'h-[42px]',
    label: 'hidden',
    input: 'w-full h-[39px] pl-7 bg-grey-100 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute top-[10px] right-[10px]',
  },
  [InputStyle.WHITE_ICON_LEFT]: {
    container: 'h-[50px]',
    label: 'hidden',
    input: 'w-full h-[39px] pl-8 bg-grey-100 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute top-[10px] left-[px]',
  },
  [InputStyle.WHITE_ICON_RIGHT]: {
    container: 'h-[50px] flex items-center',
    label: 'hidden',
    input: 'w-full h-[50px] pl-7 bg-grey-100 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
    icon: 'absolute right-[18px]',
  },
  [InputStyle.ICON_LEFT]: {
    container: 'h-[42px] flex items-center',
    label: 'hidden',
    input: 'w-full h-[42px] pl-[50px] bg-grey-100 dark:bg-grey-825 rounded-[10px] font-body text-sm tracking[.006rem]',
