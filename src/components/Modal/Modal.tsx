...
const Modal = ({modalHeader, children}: Props) => {
  return (
    <div className='absolute top-0 left-0 right-0 h-screen w-screen bg-transparent-grey flex justify-center pt-[53px]'>
      <div className='flex flex-col w-[750px] h-[780px] bg-white rounded-[20px]'>
        <div className='flex h-[61px] flex-row-reverse items-center w-full border-b-[1px] border-off-white-1'>
