...
export const MODAL_STYLE_MAPS: Record<ModalStyle, ModalElements> = {
  [ModalStyle.WIDE]: {
    outerContainer: 'w-[620px] max-w-screen h-screen my-auto py-[4%]',
  ...
  [ModalStyle.CENTERED_HEADING]: {
    outerContainer: 'w-[650px] max-w-screen h-screen my-auto py-[4%]',
  ...
  [ModalStyle.COMPACT]: {
    outerContainer: 'w-[485px] max-w-screen h-screen my-auto py-[4%]',
    innerContainer: 'rounded-[15px]',
    headerContainer: 'h-[41px] place-content-between',
    childrenContainer: 'px-[15px] pb-[21px]',
    isHeaderAtTop: true,
