...
const ExternalCard = ({id, isPaymentCard}: Props) => (
  <div data-testid='card-container' className={`dark:bg-grey-825 flex flex-col font-body-4 shadow-sm rounded-[8px] p-[6px] ${isPaymentCard ? 'h-[52px] w-[200px]' : 'h-[43px] w-[180px]'}`}>
