...
import {getSelectedDirectoryMerchantEntity, reset} from 'features/directoryMerchantSlice'
...
const DirectorySingleViewModal = () => {
  ...
  const entity = useAppSelector(getSelectedDirectoryMerchantEntity)
  ...
  const renderComments = () => ( // TODO: render comments
