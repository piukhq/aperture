...
export const useMidManagementSecondaryMids = ({skipGetSecondaryMids = false, skipGetSecondaryMid = false, planRef = '', merchantRef = '', secondaryMidRef = '', locationRef = ''}) => {
  ...
  const {data: getMerchantSecondaryMidLocationsResponse, isLoading: getMerchantSecondaryMidLocationsIsLoading, error: getMerchantSecondaryMidLocationsError} = useGetMerchantSecondaryMidLocationsQuery({planRef, merchantRef, secondaryMidRef}, {skip: skipGetSecondaryMid})
